  ...
  return (
    <Router>
      <header className="fixed top-0 left-0 w-full px-6 py-4 z-50 flex justify-between items-center text-pink-600 bg-white/80 backdrop-blur">
        <div className="text-lg font-bold tracking-tight">SLO BURN Rx</div>
        <nav className="space-x-4 text-xs uppercase">
          ...
          <Link to="/signup" className="hover:text-fuchsia-500">Join</Link>
        </nav>
      </header>
